  ...
  const { values, touched, errors, handleChange, handleBlur, handleSubmit } =
    useFormik({
      ...
      onSubmit: (values, { resetForm }) => {
        ...
        axios
          .post("http://localhost:5000/product/update_product", {
            ...values,
            productImage: url,
          })
          .then((res) => {
    ...
    <div className="flex flex-col items-center justify-center h-screen">
      ...
      <div className="w-full max-w-md bg-white rounded-lg shadow-md p-6">
        ...
        >
          ...
          <button
            type="submit"
            className={`bg-gradient-to-r bg-blue-500 text-white font-bold py-2 px-4 rounded-md mt-4 hover:bg-indigo-600 hover:to-blue-600 transition ease-in-out duration-150`}
          >
            Done
          </button>
        </form>
